 ...
 */
public class PentominoL extends AbstractPentominoParcel {	
	/**
	...
	public PentominoL(double _cost, int _number) {
	 ...
	 */
	public PentominoL(double _cost, int _number, int _x, int _y, int _z) {
		this(_cost, _number, _x, _y, _z, 0); //TODO color randomization
	}
	 ...
	 */
	public PentominoL(double _cost, int _number, int _x, int _y, int _z, int _colorID) {
